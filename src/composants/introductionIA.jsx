...
function IntroductionIA({prompt, pathSkip}) {
  ...
  return(
    <div className="bg-white border-start shadow-sm d-flex flex-column"
      ...
      <button onClick={() => navigate(pathSkip)} className="btn btn-primary btn-sm px-md-5 py-md-3 px-4 rounded-pill fw-bold d-flex flex-wrap justify-content-center gap-3 mt-4 border-0" >
