        ...
        <div className="col-lg-8 bg-white p-5 shadow-lg rounded-4">
          ...
          <header className="text-center mb-5">
            <h1 className="display-5 fw-bold text-primary">
              Calculer astucieusement avec le Développement
            </h1>
            <p className="lead text-dark fw-bold mt-4">
              Pour calculer des multiplications difficiles de tête sans
              calculatrice, il existe une technique secrète :
              la distributivité ! Dans cette leçon,
              tu vas apprendre à décomposer les nombres pour transformer des
              calculs complexes en opérations simples et super rapides.              <br />
              <br />
            </p>
          </header>
          ...
          <div className="card bg-light border-0 p-3 mb-5">
            ...
            <footer className="d-flex justify-content-center gap-4 mt-5 pt-4 border-top">
              ...
              >
                <button onClick={() => navigate("/PratiqueGuideCalculDeveloppement")} className="btn btn-sm px-md-5 py-md-3 px-4 rounded-pill fw-bold d-flex flex-wrap justify-content-center gap-3 mt-4" style={{ backgroundColor: 'deepskyblue', color: 'white' }}>
                  Pratique Guidée
                </button>
              </motion.div>
