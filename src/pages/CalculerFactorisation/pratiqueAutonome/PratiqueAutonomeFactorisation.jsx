...
export default function PratiqueAutonomeFactorisation() {
  ...
  // --- LOGIQUE MATHÉMATIQUE (FACTORISATION) ---
  ...
  function verifierReponse() {
    // 1. Nettoyage des saisies
    const e1 = etape1.replace(/\s+/g, ''); // On garde les parenthèses pour vérifier la factorisation !
    const e2 = etape2.replace(/\s+/g, '');
    const e3 = Number(etape3);

    // 2. Vérification Étape 1 (Ex: "5*(13-3)" ou "(13-3)*5")
    ...
    // 3. Vérification Étape 2 (Ex: "5*10" ou "10*5")
            ...
            <div className="animate__animated animate__fadeIn">
              ...
              {(score / totalQuestions) >= 0.75 ? (
                ...
                <div className="alert alert-danger rounded-4 p-3 p-md-4">
                  ...
                  <button className="btn btn-danger rounded-pill px-4 fw-bold w-100" onClick={() => navigate("/ModelageCalculFactorisation")}>
                    Retour Modelage
                  </button>
                </div>
              )}
