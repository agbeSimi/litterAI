...
function ExempleResolutionDevExp2() {
      ...
      jsx: (
        <div>
          ...
          <p className="fs-4 mb-0">
            <span className="text-warning fw-bold">3</span>( <span className="text-success fw-bold">a</span> + <span className="text-info fw-bold">5</span> )
          </p>
        </div>
      )
    },
      ...
      jsx: (
        <div>
          <p className="mb-1">
            ...
            Le <span className="text-warning fw-bold">3</span> attaque le <span className="text-success fw-bold">a</span>
          </p>
          <p className="ms-4 mb-0 fs-5">
            ↪ <span className="text-warning fw-bold">3</span> * <span className="text-success fw-bold">a</span>
          </p>
        </div>
      )
    },
      ...
      jsx: (
        <div>
          <p className="mb-1">
            ...
            Le <span className="text-warning fw-bold">3</span> attaque le <span className="text-info fw-bold">5</span>
          </p>
          <p className="ms-4 mb-0 fs-5">
            ↪ <span className="text-warning fw-bold">3</span> * <span className="text-info fw-bold">5</span>
          </p>
        </div>
      )
    },
      ...
      jsx: (
        <div className="mt-3 p-3 bg-secondary bg-opacity-25 rounded border border-secondary">
          ...
          <p className="fs-4 text-center fw-bold mb-0">
            (<span className="text-warning">3</span> * <span className="text-success">a</span>) + (<span className="text-warning">3</span> * <span className="text-info">5</span>)
          </p>
        </div>
      )
    }
...
export default ExempleResolutionDevExp2;