        ...
        <div className="col-lg-8 bg-white p-5 shadow-lg rounded-4">
          ...
          <div className="card bg-light border-0 p-3 mb-5">
            ...
            <footer className="d-flex justify-content-center gap-4 mt-5 pt-4 border-top">
              ...
              >
                <button onClick={() => navigate("/pratiqueGuide3")} className="btn btn-sm px-md-5 py-md-3 px-4 rounded-pill fw-bold d-flex flex-wrap justify-content-center gap-3 mt-4" style={{ backgroundColor: 'deepskyblue', color: 'white' }}>
                  Pratique Guidée
                </button>
              </motion.div>
